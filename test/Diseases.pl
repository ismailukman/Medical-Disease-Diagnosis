...
% This is not a shell as initially planned
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

notice:-
write('This is an Example of an Expert System for Diagnosing some Diseases'),
nl,
write('To use it, just answer Yes or No to the questions.'),nl,
nl.
