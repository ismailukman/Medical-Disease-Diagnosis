...
disease(Patient,maleria) :-
        symptom(Patient,headache),
        symptom(Patient,fever),
		symptom(Patient,chills),
		symptom(Patient,frequent_sweating).

disease(Patient,typhoid) :-
        symptom(Patient,fever),
...
diagnose:-nl,write('Diagnosing a Medical disease..........'),nl,
 write("What is the patient's name? "),
 readln(His_name),
 %write("How old are you? "),
% readln(Age),write("Gender? "),%readln(Gender),
 disease(symptom,Disease) ,!,nl,

write(His_name), write('The disease could be '), write(Disease).
         %write(His_name,'probably has ',Disease,'.'),nl.
